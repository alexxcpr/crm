...
async function save() {
  ...
  if (!props.dashboardId) await navigateTo(`/builder/dashboards/${saved.id_ui_dashboard}`)
}
</script>
  ...
  <div v-if="catalog" class="space-y-6">
    <div class="flex flex-wrap items-start justify-between gap-4">
      ...
      <div class="flex gap-2">
        <UButton label="Inapoi" icon="i-lucide-arrow-left" color="neutral" variant="outline" to="/builder/dashboards" />
