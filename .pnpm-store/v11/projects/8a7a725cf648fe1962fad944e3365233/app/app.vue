...
useHead({
  ...
  htmlAttrs: {
    lang: computed(() => branding.value.locale.split('-')[0] || 'ro')
  }
})

const title = computed(() => `${branding.value.organizationName} | Moduvis`)
...
<template>
  <UApp :toaster="{ position: 'top-center', duration: 10000 }">
